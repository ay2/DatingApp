...
namespace API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            var messages = await _uow.MessageRepository.GetMessageThread(caller, otherUser);
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            if (group.Connections.Any(x => x.Username == recipient.UserName))   // in the chat
            {
        ...
        // create unique group name in form 'username-username' in alphabethical order
        private string GetGroupName(string caller, string other)
        {
            var stringCompare = string.CompareOrdinal(caller, other) < 0; // caller first?
